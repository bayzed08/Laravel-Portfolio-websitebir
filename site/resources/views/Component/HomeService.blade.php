<div class="container section-marginTop text-center p-3" style="background-color: beige;border:2px solid rgb(237, 222, 184);border-radius: 10px;">
    ...
    <div class="row">
        ...
        <div class="col-md-3 p-2 ">
            <div class="card service-card text-center w-100">
                <div class="card-body">
                    <img class="service-card-logo " src="{{ url($service->service_img) }}" alt="Card image cap">
